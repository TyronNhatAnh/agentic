...
- [ ] `sdk/brain_session.py` thay [brain.py](src/agentic/brain.py): 1 SDKClient/thread, system_prompt = `brain_sdk.md` (Phase 1 chốt cùng anh — file riêng cho rollback flag, không đụng `brain.md` legacy)
