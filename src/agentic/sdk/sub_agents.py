...
# write, no MCP tool. The revamp pipeline also runs this prompt as a one-shot SDK
# query per module (revamp_pipeline.py); the AgentDefinition is the interactive
# entry point via the brain's Task tool.
